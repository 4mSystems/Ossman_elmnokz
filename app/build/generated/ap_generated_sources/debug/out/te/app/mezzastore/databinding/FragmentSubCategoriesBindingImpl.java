...
public class FragmentSubCategoriesBindingImpl extends FragmentSubCategoriesBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((te.app.mezzastore.pages.subCategories.viewModels.SubCategoriesViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewmodel((te.app.mezzastore.pages.subCategories.viewModels.SubCategoriesViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewmodel(te.app.mezzastore.pages.subCategories.viewModels.SubCategoriesViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
