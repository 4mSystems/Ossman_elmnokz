...
public class FragmentAboutBindingImpl extends FragmentAboutBinding  {
    ...
    @NonNull
    private final te.app.ossman_elmonkz.customViews.views.CustomTextViewRegular mboundView1;
    // variables
    // values
    // listeners
    ...
    private FragmentAboutBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.mboundView1 = (te.app.ossman_elmonkz.customViews.views.CustomTextViewRegular) bindings[1];
    ...
    protected void executeBindings() {
        ...
        java.lang.String viewmodelAboutMainAboutDataBody = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
                ...
                if (viewmodelAboutMainAboutData != null) {
                    // read viewmodel.aboutMain.aboutData.body
                    viewmodelAboutMainAboutDataBody = viewmodelAboutMainAboutData.getBody();
                }
        }
        // batch finished
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView1, viewmodelAboutMainAboutDataBody);
        }
    }
    ...
    /* flag mapping
        ...
        flag 1 (0x2L): viewmodel.aboutMain
        flag 2 (0x3L): null
    flag mapping end*/
    //end
}