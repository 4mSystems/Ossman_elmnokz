...
public class FragmentBrandModelsPartionBindingImpl extends FragmentBrandModelsPartionBinding  {
    ...
    public FragmentBrandModelsPartionBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private FragmentBrandModelsPartionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewmodel == variableId) {
            setViewmodel((te.app.ossman_elmonkz.pages.buying.viewModels.BrandModelViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewmodel(@Nullable te.app.ossman_elmonkz.pages.buying.viewModels.BrandModelViewModel Viewmodel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewmodel((te.app.ossman_elmonkz.pages.buying.viewModels.BrandModelViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewmodel(te.app.ossman_elmonkz.pages.buying.viewModels.BrandModelViewModel Viewmodel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
        ...
        else if (fieldId == BR.brandModelAdapter) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
            return true;
    ...
    protected void executeBindings() {
        ...
        te.app.ossman_elmonkz.pages.buying.adapter.BrandModelAdapter viewmodelBrandModelAdapter = null;
        ...
        te.app.ossman_elmonkz.pages.buying.viewModels.BrandModelViewModel viewmodel = mViewmodel;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
                ...
                if (viewmodel != null) {
                    // read viewmodel.brandModelAdapter
                    viewmodelBrandModelAdapter = viewmodel.getBrandModelAdapter();
                }
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            te.app.ossman_elmonkz.base.ApplicationBinding.getItemsV2Binding(this.rcProducts, viewmodelBrandModelAdapter, "1", "1");
        }
        if ((dirtyFlags & 0x5L) != 0) {
            // api target 1
    ...
    public static class OnTextChangedImpl implements androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged{
        private te.app.ossman_elmonkz.pages.buying.viewModels.BrandModelViewModel value;
        public OnTextChangedImpl setValue(te.app.ossman_elmonkz.pages.buying.viewModels.BrandModelViewModel value) {
            this.value = value;
    ...
    /* flag mapping
        ...
        flag 1 (0x2L): viewmodel.brandModelAdapter
        flag 2 (0x3L): null
    flag mapping end*/
    //end
}