...
public final class DaggerIApplicationComponent implements IApplicationComponent {
  ...
  private void initialize(final ConnectionModule connectionModuleParam) {
    ...
    this.buyingRepositoryProvider = DoubleCheck.provider(BuyingRepository_Factory.create(connectionHelperProvider, connectionHelperProvider, connectionHelperProvider));
  }
