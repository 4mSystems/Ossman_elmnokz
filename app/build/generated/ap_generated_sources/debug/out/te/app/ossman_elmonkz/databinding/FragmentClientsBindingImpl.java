...
public class FragmentClientsBindingImpl extends FragmentClientsBinding implements te.app.ossman_elmonkz.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener searchInputandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            // Inverse of viewmodel.selectGov
            //         is viewmodel.selectGov = (java.lang.String) callbackArg_0
            ...
            // viewmodel.selectGov
            java.lang.String viewmodelSelectGov = null;
            // viewmodel
            ...
            if (viewmodelJavaLangObjectNull) {
                ...
                viewmodel.selectGov = ((java.lang.String) (callbackArg_0));
            }
        }
    };
    ...
    private FragmentClientsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback19 = new te.app.ossman_elmonkz.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            if ((dirtyFlags & 0x5L) != 0) {
                    ...
                    if (viewmodel != null) {
                        // read viewmodel.selectGov
                        viewmodelSelectGov = viewmodel.selectGov;
                    }
            }
        }
        // batch finished
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.searchInput.setOnClickListener(mCallback19);
        ...
        if ((dirtyFlags & 0x5L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.searchInput, viewmodelSelectGov);
        }
    }
