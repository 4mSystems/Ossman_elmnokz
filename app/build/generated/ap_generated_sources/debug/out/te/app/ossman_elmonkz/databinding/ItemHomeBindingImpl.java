...
public class ItemHomeBindingImpl extends ItemHomeBinding implements te.app.ossman_elmonkz.generated.callback.OnClickListener.Listener {
    ...
    private ItemHomeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback5 = new te.app.ossman_elmonkz.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((te.app.ossman_elmonkz.pages.home.viewModels.ItemCategoryViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable te.app.ossman_elmonkz.pages.home.viewModels.ItemCategoryViewModel ItemViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((te.app.ossman_elmonkz.pages.home.viewModels.ItemCategoryViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItemViewModel(te.app.ossman_elmonkz.pages.home.viewModels.ItemCategoryViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        te.app.ossman_elmonkz.pages.home.models.CategoriesItem itemViewModelCategoriesItem = null;
        java.lang.String itemViewModelCategoriesItemTitle = null;
        te.app.ossman_elmonkz.pages.home.viewModels.ItemCategoryViewModel itemViewModel = mItemViewModel;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            te.app.ossman_elmonkz.base.ApplicationBinding.loadImage(this.catImage, itemViewModelCategoriesItemImage);
