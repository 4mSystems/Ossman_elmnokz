...
public class ItemCartBindingImpl extends ItemCartBinding implements te.app.mezzastore.generated.callback.OnClickListener.Listener {
    ...
    private ItemCartBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback3 = new te.app.mezzastore.generated.callback.OnClickListener(this, 3);
        mCallback1 = new te.app.mezzastore.generated.callback.OnClickListener(this, 1);
        mCallback2 = new te.app.mezzastore.generated.callback.OnClickListener(this, 2);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.itemViewModel == variableId) {
            setItemViewModel((te.app.mezzastore.pages.cart.viewModels.ItemCartViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItemViewModel(@Nullable te.app.mezzastore.pages.cart.viewModels.ItemCartViewModel ItemViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItemViewModel((te.app.mezzastore.pages.cart.viewModels.ItemCartViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItemViewModel(te.app.mezzastore.pages.cart.viewModels.ItemCartViewModel ItemViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        te.app.mezzastore.pages.cart.viewModels.ItemCartViewModel itemViewModel = mItemViewModel;
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.decrement.setOnClickListener(mCallback2);
            this.increment.setOnClickListener(mCallback1);
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            te.app.mezzastore.base.ApplicationBinding.loadImage(this.productImage, itemViewModelProductMainImage);
