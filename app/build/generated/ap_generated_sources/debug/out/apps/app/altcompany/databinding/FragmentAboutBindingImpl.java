...
public class FragmentAboutBindingImpl extends FragmentAboutBinding  {
    ...
    protected void executeBindings() {
        ...
        java.lang.String aboutViewModelPrivacyDataDetails = null;
        apps.app.altcompany.pages.auth.register.models.PrivacyPolicy aboutViewModelPrivacyData = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
                ...
                if (aboutViewModel != null) {
                    // read aboutViewModel.privacyData
                    aboutViewModelPrivacyData = aboutViewModel.getPrivacyData();
                }


                if (aboutViewModelPrivacyData != null) {
                    // read aboutViewModel.privacyData.details
                    aboutViewModelPrivacyDataDetails = aboutViewModelPrivacyData.getDetails();
                }
        }
        // batch finished
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView1, aboutViewModelPrivacyDataDetails);
        }
    }
    ...
    /* flag mapping
        ...
        flag 1 (0x2L): aboutViewModel.privacyData
        flag 2 (0x3L): null
    flag mapping end*/
    //end
}