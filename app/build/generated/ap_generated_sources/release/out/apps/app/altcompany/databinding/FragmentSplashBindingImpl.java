...
public class FragmentSplashBindingImpl extends FragmentSplashBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.img_splash_logo, 1);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.splashViewModel == variableId) {
            setSplashViewModel((apps.app.altcompany.pages.splash.SplashViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setSplashViewModel(@Nullable apps.app.altcompany.pages.splash.SplashViewModel SplashViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeSplashViewModel((apps.app.altcompany.pages.splash.SplashViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeSplashViewModel(apps.app.altcompany.pages.splash.SplashViewModel SplashViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
