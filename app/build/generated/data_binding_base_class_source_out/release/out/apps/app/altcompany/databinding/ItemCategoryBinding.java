...
public abstract class ItemCategoryBinding extends ViewDataBinding {
  @Bindable
  protected ItemCategoriesViewModel mItemViewModel;

  protected ItemCategoryBinding(Object _bindingComponent, View _root, int _localFieldCount) {
    super(_bindingComponent, _root, _localFieldCount);
  }

  public abstract void setItemViewModel(@Nullable ItemCategoriesViewModel itemViewModel);

  @Nullable
  public ItemCategoriesViewModel getItemViewModel() {
